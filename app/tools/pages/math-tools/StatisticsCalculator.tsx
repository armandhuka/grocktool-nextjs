...
const StatisticsCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-toolnest-bg">
      <Helmet>
        <title>Statistics Calculator - GrockTool</title>
        <meta name="description" content="Calculate mean, median, mode, standard deviation, and more statistical measures with GrockTool's free statistics calculator." />
