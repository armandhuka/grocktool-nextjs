...
const QuadraticSolver = () => {
  ...
  return (
    <div className="min-h-screen bg-toolnest-bg">
      <Helmet>
        <title>Quadratic Equation Solver - GrockTool</title>
        <meta name="description" content="Solve quadratic equations and find roots with step-by-step solutions using GrockTool's free quadratic solver." />
