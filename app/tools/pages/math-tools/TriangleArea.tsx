...
const TriangleArea = () => {
  ...
  return (
    <div className="min-h-screen bg-toolnest-bg">
      <Helmet>
        <title>Triangle Area Calculator - GrockTool</title>
        <meta name="description" content="Calculate triangle area using base & height or Heron's formula with GrockTool's free triangle calculator." />
