        ...
        <div className="toolnest-container max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-toolnest-text/70 max-w-2xl mx-auto">
              Convert between different weight units including kilograms, pounds, grams, ounces and more
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-toolnest-text/70 leading-relaxed">
              This weight converter uses standard conversion factors to convert between different units of weight and mass. 
              All conversions are calculated through kilograms as the base unit for accuracy. The tool supports 
              both metric (kilograms, grams, tons) and imperial (pounds, ounces, stones) weight systems.
            </p>
          </motion.div>
        </div>
      </div>
